...
// permitimos el uso de multihilos
define('SCKM_THREAD', true);
/**
 * La funcionalidad de multihilos está completamente basada en la de phpsocketmaster,
 * no se le hizo absolutamente ningún cambio, lo cual nos recuerda la advertencia
 * realizada en la librería de phpsocketmaster, el tema de multihilos está en 
 * desarrollo y es experimental, queda bajo su responsabilidad el uso del mismo en 
